    ...
    public function handle(): int {
        ...
        foreach ($records as $record) {
            ...
            $prisoner = Prisoner::create([
                ...
                'ideologies'           => is_array($record['Ideologies'] ?? null) ? json_encode($record['Ideologies']) : ($record['Ideologies'] ?? null),
                'era'                  => $record['Era'] ?? null,
                'affiliation'          => is_array($record['Affiliation'] ?? null) ? json_encode($record['Affiliation']) : ($record['Affiliation'] ?? null),
