...
class ContactSubmissionResource extends Resource {
    ...
    public static function getEloquentQuery(): Builder {
        return parent::getEloquentQuery()->where('form_type', 'contact');
    }

    public static function getNavigationBadge(): ?string {
        $count = FormSubmission::where('form_type', 'contact')->where('status', 'new')->count();
        ...
        return $infolist
            ->schema([
                Infolists\Components\Section::make('Submission Details')
                    ->schema([
                        Infolists\Components\TextEntry::make('data.name')
                            ->label('Name'),
