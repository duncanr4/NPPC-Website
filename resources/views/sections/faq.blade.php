    ...
    <div style="max-width:900px; margin:0 auto; padding:0 24px;">
        ...
        @foreach($faqs as $faq)
            <div class="faq-item" style="border-bottom:1px solid rgba(255,255,255,0.12);">
                <button class="faq-toggle" onclick="toggleFaq(this)" style="width:100%; display:flex; justify-content:space-between; align-items:center; padding:20px 0; background:none; border:none; cursor:pointer; text-align:left;">
                    <span style="font-size:17px; font-weight:500; color:rgba(255,255,255,0.85);">{{ $faq->question }}</span>
                    <svg class="faq-chevron" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="rgba(255,255,255,0.5)" stroke-width="2" viewBox="0 0 24 24" style="flex-shrink:0; margin-left:16px; transition:transform 0.2s;">
                        <path d="M6 9l6 6 6-6"/>
                    </svg>
                </button>
...
function toggleFaq(btn) {
    ...
    if (!isOpen) {
        ...
        // Change border color to indigo when open
